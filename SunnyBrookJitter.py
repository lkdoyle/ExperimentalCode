...
def noiseEstimation(chosenImage, Clock, Screen, expData):
    noiseScale = visual.RatingScale(Screen, choices=None, low=0, high=300, tickMarks=None, mouseOnly=True, showValue=False, acceptText='Match')
    ...
    pres =  visual.ImageStim(Screen, im, pos=(0, 4), size=(8,8))
